@icon("res://addons/total_recall/icons/ObjectiveDisplay.svg")
extends Control
...
func _create_example_objectives() -> void:
	...
	_add_objective_to_dict("first_task", make_objective("You're Welcome!", "Complete your first NPC quest!", true, "res://addons/total_recall/icons/DoYourFirstQuestIcon.png"))
