...
func _enter_tree() -> void:
	...
	add_custom_type("SimplifiableTilemapLayer", "TilemapLayer", preload("simplifiable_tilemap.gd"), preload("icons/SimplifiableTileMapLayer.svg"))
...
func _exit_tree() -> void:
	...
	remove_custom_type("SimplifiableTilemapLayer")
